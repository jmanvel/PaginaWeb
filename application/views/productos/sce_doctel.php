<div class="container-fluid">
    <div class="carousel fade-carousel-doctel slides-doctel" data-ride="carousel" data-interval="4000" id="bs-carousel">
        <!-- Overlay -->
        ...
        <div class="carousel-inner">
            <div class="item slides-doctel active">
                <div class="slide-1-doctel"></div>
                <div class="hero">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-12">
                                    <div class="col-sm-5" style="text-align: left;">
                                        <p style="text-transform: inherit;">Como el papel pero sin papel. </p>
                                        <h1>DOCTEL</h1>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container-fluid" style="background: #f4f4f4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="col-sm-12">
                        <div class="col-sm-12 cursor" onclick="productos('doctel.php')" style="margin-top: -197px">
                            <div class="col-sm-12 services">
                                <div class="row" style="margin-top: 80px; margin-left: 20px">
                                    <div class="col-sm-2"></div>
                                    <div class="col-sm-10" id="servicios">
                                        <p>Es un nuevo aplicativo comercializado por SINTAD. El cual procesa la emisi&oacute;n y transmici&oacute;n electr&oacute;nica 
                                            de sus comprobantes de una manera sencilla, &aacute;gil y segura, bajo las normativas vigentes que exige la Superintendencia Nacional de Aduanas y de Administraci&oacute;n 
                                            Tributaria SUNAT</p>
                                    </div>
                                </div>
                            </div>
