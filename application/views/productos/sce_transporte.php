                        ...
                        <div class="col-sm-12 services">
                            <div class="row" style="margin-top: 65px; margin-left: -45px">
                                ...
                                <div class="col-sm-10" id="servicios">
                                    ...
                                    <span id="scesistemaprod">TRANSPORTE</span> 
                                </div>
                            </div>
                        </div>
                        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-5">
                            <h2 style="color: #79b93d; margin-left:12px"><strong>SCE TRANSPORTE </strong> - Operativo</h2>
                        </div>
                        <div class="col-sm-7">
                            <p style="text-align: justify; font-size: 17px">Sistema orientado a la administraci&oacute;n y seguimiento de los procesos de distribuci&oacute;n del transporte terrestre nacional de mercanc&iacute;as;
                                incluye rentabilidad por viaje, chofer y veh&iacute;culo. Tambi&eacute;n incluye control del combustible, gastos, llantas, etc. 
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="col-sm-7" style="text-align: justify;margin-top: 285px; margin-left: 10px">
                <div class="col-sm-11" style="margin-left: 2%; max-width: 99%">
                    <h2 style="color: #79b93d"> <strong>SCE </strong>- Provisiones</h2>
                    ...
                    <br>
                    <button class="btn  btn-lg transporteboton" role="button">Mas sobre SCE-Doctel</button>
                    <h2 style="color: #79b93d; margin-top: 80px"> <strong>SCE </strong>- Bancos</h2>
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-5">
                            <h2 style="color: #79b93d; margin-left:12px"><strong>SCE </strong> - Sueldos</h2>
                        </div>
                        <div class="col-sm-7">
        ...
        <div class="row" style="margin-top: 80px;">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-5">
                            <h2 style="color: #79b93d; margin-left:12px"><strong>SCE </strong> - Contabilidad</h2>
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div class="overlay_wrapper" style="margin-left: 20px">
                        <div class="overlay_fade">
                            <a href="#myModal" data-toggle="modal" class="lightbox"><div class="overlay_zoom zoom_white"></div>
                                <img src="<?php echo base_url(); ?>assets/img/video-03.jpg" height="100%" width="100%" style="alignment-adjust: central">
                            </a>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">SCE Transporte</h4>
            </div>
            <div class="modal-body">
                <iframe width="100%" height="500px" src="https://www.youtube.com/embed/JOtrNaRDjHA?rel&autoplay=1" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</div>