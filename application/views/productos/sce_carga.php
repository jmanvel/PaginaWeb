        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-5">
                            <h2 style="color: #e5691f; margin-left:12px"><strong>SCE CARGA </strong> - Operativo</h2>
                        </div>
                        <div class="col-sm-7">
                            <p style="text-align: justify; font-size: 17px">Sistema orientado al control y al seguimiento del transporte de carga internacional; iniciando 
                                desde la cotizaci&oacute; a su cliente, los procesos del embarque, el seguimiento de la traves&iacute;a de la mercanc&iacute;a  hasta la llegada al puerto destino; 
                                adem&aacute;s de la interconexci&oacute;n electr&oacute;nica de los manifestos de carga con la aduana de destino. 
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-11" style="background: #fff;margin-left: 26px">
                            <div class="row" style="margin-top: 80px; padding-bottom: 80px" >
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <p style="text-align: justify; font-size: 17px">Desglose o desconsolide en cualquier momento su mercaderia desde cualquier dispositivo movil. SINTAD pone a disposicion de los agentes de carga internacional, 
        ...
        <div class="container">
            <div class="col-sm-6" style="text-align: justify;margin-top: 120px; margin-left: 10px">
                <div class="col-sm-12" style="margin-left: 2%; max-width: 99%">
                    <h2 style="color: #e5691f"> <strong>SCE </strong>- Provisiones</h2>
                    ...
                    <br>
                    <button class="btn  btn-lg cargaboton" role="button">Mas sobre SCE-Doctel</button>
                    <h2 style="color: #e5691f; margin-top: 80px"> <strong>SCE </strong>- Bancos</h2>
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-5">
                            <h2 style="color: #e5691f; margin-left:12px"><strong>SCE </strong> - Sueldos</h2>
                        </div>
                        <div class="col-sm-7">
        ...
        <div class="row" style="margin-top: 80px;">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-5">
                            <h2 style="color: #e5691f; margin-left:12px"><strong>SCE </strong> - Contabilidad</h2>
                        </div>
                        <div class="col-sm-7">
